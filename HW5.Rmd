...
baltimore.prop = 
  prop.test(baltimore$solved, baltimore$unsolved) %>% 
    broom::tidy()

pull(baltimore.prop, estimate)  
pull(baltimore.prop, conf.low) 
pull(baltimore.prop, conf.high)

```

```{r}
prop_data = 
  prop.test(homicide_data$unsolved, homicide_data$solved) 
